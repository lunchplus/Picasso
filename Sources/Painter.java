 ...
 * and saves the rendered image with a unique filename. </p>
 */
    ...
    */
    public Painter(){
        ...
        try{
            ...
            // generate a unique filename based on their file numbers
            fileName = new StringBuilder(raceFacade.getRacePrefix() + '_');
